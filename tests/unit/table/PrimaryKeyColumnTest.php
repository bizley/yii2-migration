...
/**
 * @group table
 * @group primarykeycolumn
 */
final class PrimaryKeyColumnTest extends TestCase
{
    ...
    {
        $this->column = new PrimaryKeyColumn();
    }
    ...
    {
        $this->assertSame('primaryKey({renderLength})', $this->column->getDefinition());
    }
