...
class GeneratorColumnsTest extends \bizley\tests\cases\GeneratorColumnsTestCase
{
    ...
    public function testColumnTinyInt()
    {
        ...
        $this->assertInstanceOf(TableColumnSmallInt::className(), $table->columns['col_tiny_int']);
    ...
    public function testColumnBool()
    {
        ...
        $this->assertInstanceOf(TableColumnBoolean::className(), $table->columns['col_bool']);
    ...
    public function testColumnDateTime()
    {
        ...
        $this->assertInstanceOf(TableColumnTimestamp::className(), $table->columns['col_date_time']);
    ...
    public function testColumnFloat()
    {
        ...
        $this->assertInstanceOf(TableColumnDouble::className(), $table->columns['col_float']);
