...
class GeneratorColumnsTest extends \bizley\tests\cases\GeneratorColumnsTestCase
{
    ...
    public function testColumnBool(): void
    {
        ...
        $this->assertEquals(null, $table->columns['col_bool']->size);
        $this->assertEquals(null, $table->columns['col_bool']->precision);
    ...
    public function testColumnChar(): void
    {
        ...
        $this->assertEquals(null, $table->columns['col_char']->precision);
    ...
    public function testColumnDateTime(): void
    {
        ...
        $this->assertEquals(0, $table->columns['col_date_time']->size);
    ...
    public function testColumnDecimal(): void
    {
        ...
        $this->assertEquals(null, $table->columns['col_decimal']->size);
        $this->assertEquals(10, $table->columns['col_decimal']->precision);
        $this->assertEquals(0, $table->columns['col_decimal']->scale);
    }
    ...
    public function testColumnDouble(): void
    {
        ...
        $this->assertEquals(53, $table->columns['col_double']->precision);
    ...
    public function testColumnFloat(): void
    {
        ...
        $this->assertEquals(53, $table->columns['col_float']->precision);
    ...
    public function testColumnMoney(): void
    {
        ...
        $this->assertEquals(null, $table->columns['col_money']->size);
    ...
    public function testColumnString(): void
    {
        ...
        $this->assertEquals(null, $table->columns['col_string']->precision);
